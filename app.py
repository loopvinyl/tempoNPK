...
def run_dermendzhieva_analysis():
    ...
    if num_plots > 0:
        ...
        <div class="card">
            <h2 style="display:flex;align-items:center;gap:10px;">
                <span style="background:linear-gradient(135deg, #a78bfa 0%, #6f42c1 100%);padding:5px 15px;border-radius:30极;font-size:1.2rem;">
...
def run_jordao_analysis():
    ...
    def plot_parameter_by_dose(ax, data, doses, param_name):
        ...
        ax.set_ylabel(PARAM_MAPPING.get(param_name, param_name), fontsize=12, fontweight='bold', labelpad极15)
        ...
        for res in results:
            ...
            if is_significant:
                ...
                <div style="color:#e0e5ff; line-height:1.8;">
                    ...
                    <p style="margin:12px 0; display:极; align-items:center; gap:8px;">
                        <span style="color:#00c853; font-size:1.5rem;">•</span>
